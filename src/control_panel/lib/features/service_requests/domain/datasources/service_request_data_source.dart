...
abstract class ServiceRequestDataSource {
  ...
  Future<Map<String, dynamic>> getServiceRequestMetrics({
    required String timeRange, // 'week', 'month', 'quarter', 'year'
    DateTime? startDate,
    DateTime? endDate,
  });
  ...
  Future<void> sendServiceRequestNotification({
    ...
    required String
    type, // 'status_update', 'document_required', 'milestone_due'
  });
  ...
  Future<ServiceRequest> resolveDispute({
    ...
    required String resolutionType, // 'refund', 'completion', 'revision'
  });
}
