              ...
              Row(
                children: [
                  IconButton(
                    ...
                    onPressed: () =>
                        context.go('${AppRoutes.users}/${_user!.id}'),
                      ...
                      children: [
                        ...
                        if (!_isChangePassword)
                          Padding(
                            ...
                            child: Text(
                              'Enable this option to set a new password for the user',
                        ...
                        if (_isChangePassword) ...[
                          ...
                          FormBuilderTextField(
                            ...
                            validator: _isChangePassword
                                ? FormBuilderValidators.compose([
                                    FormBuilderValidators.required(),
                                    FormBuilderValidators.minLength(8),
                                    FormBuilderValidators.match(
                                      RegExp(
                                        ValidationConstants.passwordPattern,
                                      ),
                                      errorText:
                          ...
                          FormBuilderSwitch(
                            ...
                            subtitle: Text(
                              'Send an email notifying the user of the password change',
                              style: theme.textTheme.bodyMedium?.copyWith(
                                color: theme.colorScheme.onSurface
                                    .widgetStateProperty(0.6),
                              ),
                        ...
                        if (_formKey.currentState?.fields['roles']?.hasError ??
                            false)
                          Padding(
                        ...
                        FormBuilderSwitch(
                          ...
                          subtitle: Text(
                            _user!.isActive
                                ...
                                : 'User is currently inactive and cannot log in',
                            style: theme.textTheme.bodyMedium?.copyWith(
                              color: theme.colorScheme.onSurface
                                  .widgetStateProperty(0.6),
                            ),
    ...
    if (_formKey.currentState?.saveAndValidate() ?? false) {
      ...
      try {
        ...
        if (_isChangePassword) {
          ...
          userData['sendPasswordResetEmail'] =
              formData['sendPasswordResetEmail'];
        }

        // Update user
        final userRepository = ref.read(userRepositoryProvider);
        await userRepository.updateUser(_user!.id, userData);
